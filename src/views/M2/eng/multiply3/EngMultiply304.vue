...
<table class="social">
	<tbody>
		<tr>
			...
			<td class="social" @click="share('lesson', 'Peter Addresses the Crowd: ', '/content/M2/eng/multiply3/multiply304.html')">
...
<input type="hidden" name ="notes_page"  id ="notes_page" value="M2-eng-multiply3-multiply304.html">
