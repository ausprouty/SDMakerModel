...
<div class="block ltr">
                        ...
                        <div class="chapter_title ltr"><h1>Jesus Shifts the Focus to Responsive Gentiles</h1></div>
                    </div>
...
<ul>
	<li class="up">Read or watch Acts 13:44-52 two times as others listen.</li>
</ul>

<button id="Button0" type="button" class="collapsible bible">Read Acts 13:44-52</button><div class="collapsed" id ="Text0">
<!-- begin bible -->

<p><sup class="versenum">44&nbsp;</sup>On the next Sabbath almost the whole city gathered to hear the word of the Lord.<sup class="versenum">45&nbsp;</sup>When the Jews saw the crowds, they were filled with jealousy. They began to contradict what Paul was saying and heaped abuse on him.</p>

<p><sup class="versenum">46&nbsp;</sup>Then Paul and Barnabas answered them boldly: &ldquo;We had to speak the word of God to you first. Since you reject it and do not consider yourselves worthy of eternal life, we now turn to the Gentiles.<sup class="versenum">47&nbsp;</sup>For this is what the Lord has commanded us:</p>

<p>&ldquo;&lsquo;I have made you a light for the Gentiles,<br />
&nbsp;&nbsp;&nbsp;&nbsp;that you may bring salvation to the ends of the earth.&rsquo;&rdquo;</p>

<p><sup class="versenum">48&nbsp;</sup>When the Gentiles heard this, they were glad and honored the word of the Lord; and all who were appointed for eternal life believed.</p>

<p><sup class="versenum">49&nbsp;</sup>The word of the Lord spread through the whole region.<sup class="versenum">50&nbsp;</sup>But the Jewish leaders incited the God-fearing women of high standing and the leading men of the city. They stirred up persecution against Paul and Barnabas, and expelled them from their region.<sup class="versenum">51&nbsp;</sup>So they shook the dust off their feet as a warning to them and went to Iconium.<sup class="versenum">52&nbsp;</sup>And the disciples were filled with joy and with the Holy Spirit.</p>
<!-- end bible -->
...
<button id="MC2/eng/video/multiply3/326.mp4" type="button" class="external-movie">
         Watch &nbsp;Acts 13:44-52&nbsp;</button>
...
<div>
<div>
<p><sup class="versenum">49&nbsp;</sup>The word of the Lord spread through the whole region.</p>
</div>
</div>
<!-- end bible --></div>
Growing hostility and persecution from city leaders forced Paul and Barnabas to leave the area. Even though they did not stay very long in this city, Paul and Barnabas left behind many disciples who were filled with joy and the Holy Spirit.
...
<table class="social">
	<tbody>
		<tr>
			...
			<td class="social" @click="share('lesson', 'Jesus Shifts the Focus to Responsive Gentiles: ', '/content/M2/eng/multiply3/multiply326.html')">
...
<input type="hidden" name ="notes_page"  id ="notes_page" value="M2-eng-multiply3-multiply326.html">
