...
<div class="block ltr">
                        ...
                        <div class="chapter_title ltr"><h1>Stephen is Arrested</h1></div>
                    </div>
...
<ul>
	<li class="up">Read or watch Acts 6:8-15 two times as others listen.</li>
</ul>

<button id="Button0" type="button" class="collapsible bible">Read Acts 6:8-15</button><div class="collapsed" id ="Text0">
<!-- begin bible -->

<h3>Stephen Seized</h3>

<p><sup class="versenum">8&nbsp;</sup>Now Stephen, a man full of God&rsquo;s grace and power, performed great wonders and signs among the people.<sup class="versenum">9&nbsp;</sup>Opposition arose, however, from members of the Synagogue of the Freedmen (as it was called)&mdash;Jews of Cyrene and Alexandria as well as the provinces of Cilicia and Asia&mdash;who began to argue with Stephen.<sup class="versenum">10&nbsp;</sup>But they could not stand up against the wisdom the Spirit gave him as he spoke.</p>

<p><sup class="versenum">11&nbsp;</sup>Then they secretly persuaded some men to say, &ldquo;We have heard Stephen speak blasphemous words against Moses and against God.&rdquo;</p>

<p><sup class="versenum">12&nbsp;</sup>So they stirred up the people and the elders and the teachers of the law. They seized Stephen and brought him before the Sanhedrin.<sup class="versenum">13&nbsp;</sup>They produced false witnesses, who testified, &ldquo;This fellow never stops speaking against this holy place and against the law.<sup class="versenum">14&nbsp;</sup>For we have heard him say that this Jesus of Nazareth will destroy this place and change the customs Moses handed down to us.&rdquo;</p>

<p><sup class="versenum">15&nbsp;</sup>All who were sitting in the Sanhedrin looked intently at Stephen, and they saw that his face was like the face of an angel.</p>
<!-- end bible -->

<p class="bible"></p>
</div>

<button id="MC2/eng/video/multiply3/311.mp4" type="button" class="external-movie">
         Watch &nbsp;Acts 6:8-15&nbsp;</button>
...
<div>
<div>
<p><sup class="versenum">20&nbsp;</sup>&ldquo;My prayer is not for them alone. I pray also for those who will believe in me through their message,</p>
</div>
</div>
</div>
<!-- end bible --></div>
The trouble started as a theological disagreement, then moved to slander (lies about him), conspiracy, and then to violence. The false accusations about Stephan were very serious. In fact, they were the same ones that had been used against Jesus. This was a dangerous situation, yet Stephen&rsquo;s face reflected the peace that comes from being in the presence of Jesus.
...
<table class="social">
	<tbody>
		<tr>
			...
			<td class="social" @click="share('lesson', 'Stephen is Arrested: ', '/content/M2/eng/multiply3/multiply311.html')">
...
<input type="hidden" name ="notes_page"  id ="notes_page" value="M2-eng-multiply3-multiply311.html">
