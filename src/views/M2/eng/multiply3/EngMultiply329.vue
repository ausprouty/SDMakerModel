...
<div class="block ltr">
                        ...
                        <div class="chapter_title ltr"><h1>Return to Strengthen Disciples and Appoint Leaders</h1></div>
                    </div>
...
<ul>
	<li class="up">Read or watch Acts 14:21-28&nbsp; two times as others listen.</li>
</ul>

<button id="Button0" type="button" class="collapsible bible">Read Acts 14:21-28</button><div class="collapsed" id ="Text0">
<!-- begin bible -->

<h3>The Return to Antioch in Syria</h3>

<p><sup class="versenum">21&nbsp;</sup>They preached the gospel in that city and won a large number of disciples. Then they returned to Lystra, Iconium and Antioch,<sup class="versenum">22&nbsp;</sup>strengthening the disciples and encouraging them to remain true to the faith. &ldquo;We must go through many hardships to enter the kingdom of God,&rdquo; they said.<sup class="versenum">23&nbsp;</sup>Paul and Barnabas appointed elders for them in each church and, with prayer and fasting, committed them to the Lord, in whom they had put their trust.<sup class="versenum">24&nbsp;</sup>After going through Pisidia, they came into Pamphylia,<sup class="versenum">25&nbsp;</sup>and when they had preached the word in Perga, they went down to Attalia.</p>

<p><sup class="versenum">26&nbsp;</sup>From Attalia they sailed back to Antioch, where they had been committed to the grace of God for the work they had now completed.<sup class="versenum">27&nbsp;</sup>On arriving there, they gathered the church together and reported all that God had done through them and how he had opened a door of faith to the Gentiles.<sup class="versenum">28&nbsp;</sup>And they stayed there a long time with the disciples.</p>
<!-- end bible -->
...
<button id="MC2/eng/video/multiply3/329.mp4" type="button" class="external-movie">
         Watch &nbsp;Acts 14:20-28&nbsp;</button>
...
<div>
<div>
<p><sup class="versenum">22&nbsp;</sup>strengthening the disciples and encouraging them to remain true to the faith. &ldquo;We must go through many hardships to enter the kingdom of God,&rdquo; they said.</p>
</div>
</div>
<!-- end bible --></div>
...
<p class="up">The letter to the Galatian churches can be <a  target = "_blank" href="https://www.biblegateway.com/passage/?search=Galatians%201&amp;version=NIV">read here</a>.</p>
...
<table class="social">
	<tbody>
		<tr>
			...
			<td class="social" @click="share('lesson', 'Return to Strengthen Disciples and Appoint Leaders: ', '/content/M2/eng/multiply3/multiply329.html')">
...
<input type="hidden" name ="notes_page"  id ="notes_page" value="M2-eng-multiply3-multiply329.html">
