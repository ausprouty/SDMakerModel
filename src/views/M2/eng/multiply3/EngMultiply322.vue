...
<div class="block ltr">
                        ...
                        <div class="chapter_title ltr"><h1>The Church in Antioch of Syria</h1></div>
                    </div>
...
<ul>
	<li class="up">Read or watch Acts 11:19-30 two times as others listen.</li>
</ul>

<button id="Button0" type="button" class="collapsible bible">Read Acts 11:19-30</button><div class="collapsed" id ="Text0">
<!-- begin bible -->
...
<button id="MC2/eng/video/multiply3/322.mp4" type="button" class="external-movie">
         Watch &nbsp;Acts 11:19-30&nbsp;</button>
...
<p>On that day a great persecution broke out against the church in Jerusalem, and all except the apostles were scattered throughout Judea and Samaria.</p>
</div>
</div>
<!-- end bible --></div>
were also sharing their faith, but only with other Jews. However, some of the Greek-speaking Jews from the island of Cyprus and the area of North Africa called Cyrene (modern day Libya) shared with non-Jewish people in the big multicultural city of Antioch in Syria. A large number turned to the Lord and a church began in Antioch. This was a 2nd generation church started by ordinary believers. Barnabas, who was originally from Cyprus, was sent by the Jerusalem church to validate what was taking place. He recognized the Lord was at work and realized that Saul was the perfect one to help establish this young Gentile church. It is in Antioch that the name Christian is first used to describe disciples of Jesus. The Gentile believers showed their connection to the Jewish believers by generously sending financial aid to the Jerusalem church.
...
<table class="social">
	<tbody>
		<tr>
			...
			<td class="social" @click="share('lesson', 'The Church in Antioch of Syria: ', '/content/M2/eng/multiply3/multiply322.html')">
...
<input type="hidden" name ="notes_page"  id ="notes_page" value="M2-eng-multiply3-multiply322.html">
