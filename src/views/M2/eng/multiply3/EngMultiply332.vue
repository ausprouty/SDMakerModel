...
<div class="block ltr">
                        ...
                        <div class="chapter_title ltr"><h1>Led by Jesus to Macedonia (Eastern Europe)</h1></div>
                    </div>
...
<ul>
	<li class="up">Read or watch Acts 16:6-15 two times as others listen.</li>
</ul>

<button id="Button0" type="button" class="collapsible bible">Read Acts 16:6-15</button><div class="collapsed" id ="Text0">
<!-- begin bible -->

<h3>Paul&rsquo;s Vision of the Man of Macedonia</h3>

<p><sup class="versenum">6&nbsp;</sup>Paul and his companions traveled throughout the region of Phrygia and Galatia, having been kept by the Holy Spirit from preaching the word in the province of Asia.<sup class="versenum">7&nbsp;</sup>When they came to the border of Mysia, they tried to enter Bithynia, but the Spirit of Jesus would not allow them to.<sup class="versenum">8&nbsp;</sup>So they passed by Mysia and went down to Troas.<sup class="versenum">9&nbsp;</sup>During the night Paul had a vision of a man of Macedonia standing and begging him, &ldquo;Come over to Macedonia and help us.&rdquo;<sup class="versenum">10&nbsp;</sup>After Paul had seen the vision, we got ready at once to leave for Macedonia, concluding that God had called us to preach the gospel to them.</p>

<h3>Lydia&rsquo;s Conversion in Philippi</h3>

<p><sup class="versenum">11&nbsp;</sup>From Troas we put out to sea and sailed straight for Samothrace, and the next day we went on to Neapolis.<sup class="versenum">12&nbsp;</sup>From there we traveled to Philippi, a Roman colony and the leading city of that district of Macedonia. And we stayed there several days.</p>
...
<button id="MC2/eng/video/multiply3/332.mp4" type="button" class="external-movie">
         Watch Acts 16:6-15</button>
...
<div>
<div>
<p><sup class="versenum">10&nbsp;</sup>After Paul had seen the vision, we got ready at once to leave for Macedonia, concluding that God had called us to preach the gospel to them.</p>
</div>
</div>
<!-- end bible --></div>
While seeking the Lord for their next steps, Jesus gave Paul a vision. Listening to the Holy Spirit and considering Paul&rsquo;s vision, they concluded the Lord was leading them to go to the province of Macedonia. Upon arriving, they went to the strategically important city of Philippi. The Lord led them to a person of peace named Lydia, a businesswoman from the province of Asia. She not only welcomed the message and the ministry team, but she led her whole household to faith in Jesus. As in other stories, the first act of obedience for these new believers was to be baptized.
...
<table class="social">
	<tbody>
		<tr>
			...
			<td class="social" @click="share('lesson', 'Led by Jesus to Macedonia (Eastern Europe): ', '/content/M2/eng/multiply3/multiply332.html')">
...
<input type="hidden" name ="notes_page"  id ="notes_page" value="M2-eng-multiply3-multiply332.html">
