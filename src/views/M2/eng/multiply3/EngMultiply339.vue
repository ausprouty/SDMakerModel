...
<div class="block ltr">
                        ...
                        <div class="chapter_title ltr"><h1>Believers Turn from Old Practices</h1></div>
                    </div>
...
<ul>
	<li class="up">Read or watch Acts 19:11-22 two times as others listen.</li>
</ul>

<button id="Button0" type="button" class="collapsible bible">Read Acts 19:11-22</button><div class="collapsed" id ="Text0">
<!-- begin bible -->

<p><sup class="versenum">11&nbsp;</sup>God did extraordinary miracles through Paul,<sup class="versenum">12&nbsp;</sup>so that even handkerchiefs and aprons that had touched him were taken to the sick, and their illnesses were cured and the evil spirits left them.</p>

<p><sup class="versenum">13&nbsp;</sup>Some Jews who went around driving out evil spirits tried to invoke the name of the Lord Jesus over those who were demon-possessed. They would say, &ldquo;In the name of the Jesus whom Paul preaches, I command you to come out.&rdquo;<sup class="versenum">14&nbsp;</sup>Seven sons of Sceva, a Jewish chief priest, were doing this.<sup class="versenum">15&nbsp;</sup>One day the evil spirit answered them, &ldquo;Jesus I know, and Paul I know about, but who are you?&rdquo;<sup class="versenum">16&nbsp;</sup>Then the man who had the evil spirit jumped on them and overpowered them all. He gave them such a beating that they ran out of the house naked and bleeding.</p>

<p><sup class="versenum">17&nbsp;</sup>When this became known to the Jews and Greeks living in Ephesus, they were all seized with fear, and the name of the Lord Jesus was held in high honor.<sup class="versenum">18&nbsp;</sup>Many of those who believed now came and openly confessed what they had done.<sup class="versenum">19&nbsp;</sup>A number who had practiced sorcery brought their scrolls together and burned them publicly. When they calculated the value of the scrolls, the total came to fifty thousand drachmas.<sup class="versenum">20&nbsp;</sup>In this way the word of the Lord spread widely and grew in power.</p>

<p><sup class="versenum">21&nbsp;</sup>After all this had happened, Paul decided to go to Jerusalem, passing through Macedonia and Achaia. &ldquo;After I have been there,&rdquo; he said, &ldquo;I must visit Rome also.&rdquo;<sup class="versenum">22&nbsp;</sup>He sent two of his helpers, Timothy and Erastus, to Macedonia, while he stayed in the province of Asia a little longer.</p>
<!-- end bible -->
...
<button id="MC2/eng/video/multiply3/339.mp4" type="button" class="external-movie">
         Watch &nbsp;Acts 19:11-22&nbsp;</button>
...
<p class="up"><br />
The first letter to the church in Corinth can be read here (<a  target = "_blank" href="https://www.biblegateway.com/passage/?search=1%20Corinthians%201&amp;version=NIV">1 Corinthians</a>).</p>
...
<table class="social">
	<tbody>
		<tr>
			...
			<td class="social" @click="share('lesson', 'Believers Turn from Old Practices: ', '/content/M2/eng/multiply3/multiply339.html')">
...
<input type="hidden" name ="notes_page"  id ="notes_page" value="M2-eng-multiply3-multiply339.html">
