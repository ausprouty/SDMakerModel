...
<h1>Period 4: Training Leaders for New Movement Centers</h1>
<div id="showVideoOptions"></div>
  <p>   
    <div class="zoom-image">
    <vue-image-zoomer
    regular="home/globa544/mc2.capacitor/eng/public/images/zoom//sites/mc2/content/M2/eng/multiply3/Trip2.png" 
    zoom="home/globa544/mc2.capacitor/eng/public/images/zoom//sites/mc2/content/M2/eng/multiply3/Trip2.png" :zoom-amount="3" img-class="img-fluid" alt="">
    <img src="@/assets/sites/mc2/content/M2/eng/multiply3/Trip2.png" img-class="img-fluid" />
    </vue-image-zoomer>
    </div>&nbsp;</p>

<p>(2nd Missionary Journey from Antioch) [49 - 51 AD]</p>

<h2>Summary</h2>

<p>This period covers the journey of the second mission team that was sent from Antioch. It is marked by new provincial centers being opened to the gospel, growing movements of disciple making, and additional Kingdom laborers being raised up.</p>

<h2>Letters written during this Period</h2>

<ul>
	<li>1 Thessalonians, 50/51 AD</li>
	<li>2 Thessalonians, 50/51 AD</li>
</ul>
...
<table class="social">
	<tbody>
		<tr>
			...
			<td class="social" @click="share('lesson', 'Period 4: Training Leaders for New Movement Centers: ', '/content/M2/eng/multiply3/multiply3intro4.html')">
