...
<div class="block ltr">
                        ...
                        <div class="chapter_title ltr"><h1>Believers Form a Missional Community</h1></div>
                    </div>
...
<ul>
	<li class="up">Read or watch Acts 2:42-47 two times as others listen.</li>
</ul>

<button id="Button0" type="button" class="collapsible bible">Read Acts 2:42-47</button><div class="collapsed" id ="Text0">
<!-- begin bible -->
...
<button id="MC2/eng/video/multiply3/305.mp4" type="button" class="external-movie">
...
<table class="social">
	<tbody>
		<tr>
			...
			<td class="social" @click="share('lesson', 'Believers Form a Missional Community: ', '/content/M2/eng/multiply3/multiply305.html')">
...
<input type="hidden" name ="notes_page"  id ="notes_page" value="M2-eng-multiply3-multiply305.html">
