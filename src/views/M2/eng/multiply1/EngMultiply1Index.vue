...
<div class="page_content" dir="ltr">
  ...
  <div  class="app-series-header">
    <img src="content/M2/eng/images/standard/Multiply1.png" class="app-series-header" />
  </div>
  <div>
...
<table class="social">
	<tbody>
		<tr>
			...
			<td class="social" @click="share('lesson', 'Library: ', '/content/M2/eng/multiply1/index.html')">
