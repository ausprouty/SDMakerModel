...
<a id = "Return1" href="#" onclick="goToPageAndSetReturn('../tc/tc08.html', '#Return1');">
...
<table class="social">
	<tbody>
		<tr>
			...
			<td class="social" @click="share('lesson', 'Committing to One Another : ', '/content/M2/eng/multiply1/multiply113.html')">
