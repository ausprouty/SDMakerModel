...
<div class="block ltr">
                        <div class="chapter_number ltr"><h1>26.</h1></div>
                        <div class="chapter_title ltr"><h1>Choosing Apprentice Leaders</h1></div>
                    </div>
...
<ul>
	<li class="up">Read or watch Luke 6:12-19 two times as others listen.</li>
</ul>

<button id="Button0" type="button" class="collapsible bible">Read Luke 6:12-19</button><div class="collapsed" id ="Text0">
<!-- begin bible -->

<h3>The Twelve Apostles</h3>

<p><sup class="versenum">12&nbsp;</sup>One of those days Jesus went out to a mountainside to pray, and spent the night praying to God.<sup class="versenum">13&nbsp;</sup>When morning came, he called his disciples to him and chose twelve of them, whom he also designated apostles:<sup class="versenum">14&nbsp;</sup>Simon (whom he named Peter), his brother Andrew, James, John, Philip, Bartholomew,<sup class="versenum">15&nbsp;</sup>Matthew, Thomas, James son of Alphaeus, Simon who was called the Zealot,<sup class="versenum">16&nbsp;</sup>Judas son of James, and Judas Iscariot, who became a traitor.</p>

<h3>Blessings and Woes</h3>

<p><sup class="versenum">17&nbsp;</sup>He went down with them and stood on a level place. A large crowd of his disciples was there and a great number of people from all over Judea, from Jerusalem, and from the coastal region around Tyre and Sidon,<sup class="versenum">18&nbsp;</sup>who had come to hear him and to be healed of their diseases. Those troubled by impure spirits were cured,<sup class="versenum">19&nbsp;</sup>and the people all tried to touch him, because power was coming from him and healing them all.</p>
<!-- end bible -->
...
<button id="MC2/eng/video/multiply2/226.mp4" type="button" class="external-movie">
         Watch &nbsp;Luke 6:12-19&nbsp;</button>
...
<p class="up">Jesus is shifting to a new period of the movement. The ministry and momentum were growing and people from all over Israel were believing in Him as Messiah. It is at this crucial time that Jesus issues a call for His disciples to gather. As they are gathering, Jesus goes up on a mountainside to pray, modeling for us the first principle of leadership development &ndash; dependency on God. Fresh from prayer, Jesus comes down the mountain to a level place and out of many disciples (maybe 100 or more) He publicly appoints the first 12 movement leaders. He calls them apostles, which means sent ones. This is the second principle of leadership, public appointment. In this principle, leaders are selected from a wider group of disciples who have been trained and have experience in fishing for men. He selected them so that they would be with Him (personal development) and that He would send them out to do the things He had been doing (authority for ministry).</p>

</div>

<p class="up"><span class="for-enrichment">For Further Study: <span class="popup-link" @click = "popUp('pop3')"> Mark 3:13-19</span> </span></p>

<div class="popup invisible" id="pop3"><!-- begin bible -->
<div>
<div>
<p><sup class="versenum">13&nbsp;</sup>Jesus went up on a mountainside and called to him those he wanted, and they came to him.<sup class="versenum">14&nbsp;</sup>He appointed twelve that they might be with him and that he might send them out to preach<sup class="versenum">15&nbsp;</sup>and to have authority to drive out demons.<sup class="versenum">16&nbsp;</sup>These are the twelve he appointed: Simon (to whom he gave the name Peter),<sup class="versenum">17&nbsp;</sup>James son of Zebedee and his brother John (to them he gave the name Boanerges, which means &ldquo;sons of thunder&rdquo;),<sup class="versenum">18&nbsp;</sup>Andrew, Philip, Bartholomew, Matthew, Thomas, James son of Alphaeus, Thaddaeus, Simon the Zealot<sup class="versenum">19&nbsp;</sup>and Judas Iscariot, who betrayed him.</p>
</div>
</div>
<!-- end bible --></div>
...
<table class="social">
	<tbody>
		<tr>
			...
			<td class="social" @click="share('lesson', 'Choosing Apprentice Leaders: ', '/content/M2/eng/multiply2/multiply226.html')">
...
<input type="hidden" name ="notes_page"  id ="notes_page" value="M2-eng-multiply2-multiply226.html">
