...
<div class="block ltr">
                        ...
                        <div class="chapter_title ltr"><h1>Passion Revealed at the Temple</h1></div>
                    </div>
...
<h3>Jesus Clears the Temple Courts</h3>

<p><sup class="versenum">13&nbsp;</sup>When it was almost time for the Jewish Passover, Jesus went up to Jerusalem.<sup class="versenum">14&nbsp;</sup>In the temple courts he found people selling cattle, sheep and doves, and others sitting at tables exchanging money.<sup class="versenum">15&nbsp;</sup>So he made a whip out of cords, and drove all from the temple courts, both sheep and cattle; he scattered the coins of the money changers and overturned their tables.<sup class="versenum">16&nbsp;</sup>To those who sold doves he said, &ldquo;Get these out of here! Stop turning my Father&rsquo;s house into a market!&rdquo;<sup class="versenum">17&nbsp;</sup>His disciples remembered that it is written: &ldquo;Zeal for your house will consume me.&rdquo;</p>

<p><sup class="versenum">18&nbsp;</sup>The Jews then responded to him, &ldquo;What sign can you show us to prove your authority to do all this?&rdquo;</p>

<p><sup class="versenum">19&nbsp;</sup>Jesus answered them, &ldquo;Destroy this temple, and I will raise it again in three days.&rdquo;</p>

<p><sup class="versenum">20&nbsp;</sup>They replied, &ldquo;It has taken forty-six years to build this temple, and you are going to raise it in three days?&rdquo;<sup class="versenum">21&nbsp;</sup>But the temple he had spoken of was his body.<sup class="versenum">22&nbsp;</sup>After he was raised from the dead, his disciples recalled what he had said. Then they believed the scripture and the words that Jesus had spoken.</p>

<p><sup class="versenum">23&nbsp;</sup>Now while he was in Jerusalem at the Passover Festival, many people saw the signs he was performing and believed in his name.<sup class="versenum">24&nbsp;</sup>But Jesus would not entrust himself to them, for he knew all people.<sup class="versenum">25&nbsp;</sup>He did not need any testimony about mankind, for he knew what was in each person.</p>
<!-- end bible -->
...
<button id="MC2/eng/video/multiply2/210.mp4" type="button" class="external-movie">
         Watch &nbsp;John 2:12-22&nbsp;</button>
...
<p class="up">Jesus takes His disciples to Jerusalem for the feast of the Passover. It was a seven-day festival to celebrate Israel&rsquo;s deliverance from Egypt under the leadership of Moses. We see Jesus&rsquo; passion for the Father&rsquo;s name and reputation. He was angry that the focus of the people had been taken off of worshipping the Father and onto taking advantage of people to make money. We see real human emotions here from a real human Jesus; we see real courage from a real divine Jesus. Jesus who was so in love with the Father that He could not stand by and see people make money from what God was offering as a free gift.</p>
...
<table class="social">
	<tbody>
		<tr>
			...
			<td class="social" @click="share('lesson', 'Passion Revealed at the Temple: ', '/content/M2/eng/multiply2/multiply210.html')">
...
<input type="hidden" name ="notes_page"  id ="notes_page" value="M2-eng-multiply2-multiply210.html">
