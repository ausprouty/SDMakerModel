...
<div id="showVideoOptions"></div>
  <p class="year">   
    ...
    <vue-image-zoomer
    regular="home/globa544/mc2.capacitor/eng/public/images/zoom//sites/mc2/content/M2/eng/multiply2/Period1.png" 
    zoom="home/globa544/mc2.capacitor/eng/public/images/zoom//sites/mc2/content/M2/eng/multiply2/Period1.png" :zoom-amount="3" img-class="img-fluid" alt="Stage of Ministry">
    <img src="@/assets/sites/mc2/content/M2/eng/multiply2/Period1.png" img-class="img-fluid" />
    </vue-image-zoomer>
    </div><br />
...
<table class="social">
	<tbody>
		<tr>
			...
			<td class="social" @click="share('lesson', 'Period 1 -- Preparation: ', '/content/M2/eng/multiply2/multiply2intro1.html')">
