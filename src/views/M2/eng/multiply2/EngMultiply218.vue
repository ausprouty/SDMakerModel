...
<div class="block ltr">
                        ...
                        <div class="chapter_title ltr"><h1>Fishing for Men Expedition One</h1></div>
                    </div>
...
<p class="up">Read or watch Mark 1:21-28 two times as others listen.</p>

<button id="Button0" type="button" class="collapsible bible">Read Mark 1:21-28</button><div class="collapsed" id ="Text0">
<!-- begin bible -->
...
<button id="MC2/eng/video/multiply2/218.mp4" type="button" class="external-movie">
         Watch &nbsp;Mark 1:21-28&nbsp;</button>
...
<p class="up">Jesus begins the first of six outreach events. He is training His young ministry team to reach the crowds with the Good News that He is the Messiah. The first outreach is in their place of worship, the local synagogue. There they find a group of religious but lost people. Jesus uses the first five books of the Bible to share with them who He is. He combines this with the message that it is time to repent because the Kingdom of God is here. The crowd recognizes He is different and are amazed that Jesus has command over evil spirits. It seems this is the first time Jesus has cast out a demon and news about this event spreads quickly. The demon demonstrated that he knew exactly who Jesus was, &ldquo;the Holy One of God&rdquo;.</p>

</div>

<p class="up"><span class="for-enrichment">Further Study:<span class="popup-link" @click = "popUp('pop3')">  Luke 4:31-37</span> </span></p>

<div class="popup invisible" id="pop3"><!-- begin bible -->
<div>
<div>
<p><sup class="versenum">31&nbsp;</sup>Then he went down to Capernaum, a town in Galilee, and on the Sabbath he taught the people.<sup class="versenum">32&nbsp;</sup>They were amazed at his teaching, because his words had authority.</p>

<p><sup class="versenum">33&nbsp;</sup>In the synagogue there was a man possessed by a demon, an impure spirit. He cried out at the top of his voice,<sup class="versenum">34&nbsp;</sup>&ldquo;Go away! What do you want with us, Jesus of Nazareth? Have you come to destroy us? I know who you are&mdash;the Holy One of God!&rdquo;</p>

<p><sup class="versenum">35&nbsp;</sup>&ldquo;Be quiet!&rdquo; Jesus said sternly. &ldquo;Come out of him!&rdquo; Then the demon threw the man down before them all and came out without injuring him.</p>

<p><sup class="versenum">36&nbsp;</sup>All the people were amazed and said to each other, &ldquo;What words these are! With authority and power he gives orders to impure spirits and they come out!&rdquo;<sup class="versenum">37&nbsp;</sup>And the news about him spread throughout the surrounding area.</p>
</div>
</div>
<!-- end bible --></div>
...
<table class="social">
	<tbody>
		<tr>
			...
			<td class="social" @click="share('lesson', 'Fishing for Men Expedition One: ', '/content/M2/eng/multiply2/multiply218.html')">
...
<input type="hidden" name ="notes_page"  id ="notes_page" value="M2-eng-multiply2-multiply218.html">
