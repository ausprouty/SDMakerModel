...
<div class="block ltr">
                        ...
                        <div class="chapter_title ltr"><h1>Fishers of Men</h1></div>
                    </div>
...
<p class="up">Read or watch Mark 1:16-20 two times as others listen.</p>

<button id="Button0" type="button" class="collapsible bible">Read Mark 1:16-20</button><div class="collapsed" id ="Text0">
<!-- begin bible -->

<h3>Jesus Calls His First Disciples</h3>
...
<button id="MC2/eng/video/multiply2/217.mp4" type="button" class="external-movie">
         Watch &nbsp;Mark 1:16-20&nbsp;</button>
...
<p class="up">Jesus had started his ministry about 18 months ago. Now He seeks out and formally calls certain disciples to increased commitment. Jesus invites them to become &ldquo;fishers of men.&rdquo; They had already been involved as followers. Now this call is to come closer and learn to become those who multiply disciples. Because this was a great honor for them and their families, they excitedly left everything to do so. Jesus had already modeled to them a disciple-making process by sharing the message about the Kingdom of God. An important part of the process was sharing His very life with them as well.</p>

</div>

<p class="up"><span class="for-enrichment">Further Study: <span class="popup-link" @click = "popUp('pop3')"> Matthew 4:18-22</span> </span></p>

<div class="popup invisible" id="pop3"><!-- begin bible -->
<div>
<div>
<p><sup class="versenum">18&nbsp;</sup>As Jesus was walking beside the Sea of Galilee, he saw two brothers, Simon called Peter and his brother Andrew. They were casting a net into the lake, for they were fishermen.<sup class="versenum">19&nbsp;</sup>&ldquo;Come, follow me,&rdquo; Jesus said, &ldquo;and I will send you out to fish for people.&rdquo;<sup class="versenum">20&nbsp;</sup>At once they left their nets and followed him.</p>

<p><sup class="versenum">21&nbsp;</sup>Going on from there, he saw two other brothers, James son of Zebedee and his brother John. They were in a boat with their father Zebedee, preparing their nets. Jesus called them,<sup class="versenum">22&nbsp;</sup>and immediately they left the boat and their father and followed him.</p>
</div>
</div>
<!-- end bible --></div>
...
<table class="social">
	<tbody>
		<tr>
			...
			<td class="social" @click="share('lesson', 'Fishers of Men: ', '/content/M2/eng/multiply2/multiply217.html')">
...
<input type="hidden" name ="notes_page"  id ="notes_page" value="M2-eng-multiply2-multiply217.html">
